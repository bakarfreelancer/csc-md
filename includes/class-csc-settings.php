...
<?php
	...
	private function render_password_tab( $user ) {
		ob_start();
		?>
<form class="csc-settings-form" id="csc-settings-form" data-action="csc_save_password"
    ...
    <div class="csc-settings-section">
        ...
        <div class="csc-settings-fields">
            ...
            <div class="csc-form-group csc-form-group--md">
                ...
                <input type="password" id="pw-current" name="current_password" class="csc-input"
            ...
            <div class="csc-form-group csc-form-group--md">
                ...
                <div class="csc-password-wrap">
                    <input type="password" id="pw-new" name="new_password" class="csc-input" autocomplete="new-password"
                        id="pw-new">
                    <button type="button" class="csc-pw-toggle" data-target="pw-new" aria-label="Show/hide password">
                        <svg class="csc-pw-eye" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.8"
            ...
            <div class="csc-form-group csc-form-group--md">
                ...
                <div class="csc-password-wrap">
                    <input type="password" id="pw-confirm" name="confirm_password" class="csc-input"
                        autocomplete="new-password">
                    <button type="button" class="csc-pw-toggle" data-target="pw-confirm"
...
<?php
	...
	private function render_security_tab( $user ) {
		...
		ob_start();
		?>
<form class="csc-settings-form" id="csc-settings-form" data-action="csc_save_security"
    data-nonce="<?php echo esc_attr( wp_create_nonce( 'csc_save_security' ) ); ?>">

    <div class="csc-settings-section">
        <h2 class="csc-settings-section-title">Login &amp; Security</h2>

        <?php /* 2FA option hidden until further notice
        <div class="csc-settings-toggle-row">
            <div class="csc-settings-toggle-info">
                ...
                <div class="csc-settings-toggle-desc">Get notified by email every time someone uses a new device to sign
                    into your account at login.</div>
            </div>
        ...
        */ ?>
        ...
        <div class="csc-settings-toggle-row">
            <div class="csc-settings-toggle-info">
                ...
                <div class="csc-settings-toggle-desc">Receive an email notification when your account is accessed from a new device or location.</div>
            </div>
        ...
        <div class="csc-settings-sessions">
            ...
            <div class="csc-settings-sessions-info">
                You're currently signed in on <?php echo $session_count; ?>
                device<?php echo $session_count !== 1 ? 's' : ''; ?>.
            </div>
...
<?php
	...
	private function render_notifications_tab( $user ) {
		// Newsletter: default matches consent_marketing set at registration
		$newsletter_raw = get_user_meta( $user->ID, '_csc_notif_newsletter', true );
		if ( $newsletter_raw === '' ) {
			$newsletter_raw = get_user_meta( $user->ID, '_csc_consent_marketing', true );
		}
		$newsletter = $newsletter_raw === '1';

		$forum = get_user_meta( $user->ID, '_csc_notif_forum', true );
		// Default on for forum if never set
		$forum = $forum === '' ? true : $forum === '1';

		ob_start();
		?>
<form class="csc-settings-form" id="csc-settings-form" data-action="csc_save_notifications"
    ...
    <div class="csc-settings-section">
        ...
        <div class="csc-settings-toggle-row">
            <div class="csc-settings-toggle-info">
                <div class="csc-settings-toggle-title">Marketing and Event Communications</div>
                <div class="csc-settings-toggle-desc">Yes, I consent to receiving marketing communications and details of forthcoming events from the Celtic Sea Cluster.</div>
            </div>
            <label class="csc-toggle" aria-label="Marketing and Event Communications">
                <input type="checkbox" name="notif_newsletter" value="1" <?php checked( $newsletter ); ?>>
                <span class="csc-toggle-slider"></span>
            </label>
        </div>
...
<?php
	...
	private function render_directory_tab( $user ) {
		...
		ob_start();
		?>
<form class="csc-settings-form" id="csc-settings-form" data-action="csc_save_dir_settings"
    ...
    <div class="csc-settings-section">
        ...
        <div class="csc-settings-toggle-row">
            <div class="csc-settings-toggle-info">
                ...
                <div class="csc-settings-toggle-desc">I consent to my organisation's details being included in the Celtic Sea Cluster Member Directory, where they will be visible to other members.</div>
            </div>
        ...
        <div class="csc-settings-toggle-row">
            <div class="csc-settings-toggle-info">
                ...
                <div class="csc-settings-toggle-desc">I consent to my profile, biography, and contact details being included in the Celtic Sea Cluster Member Directory, where they will be visible to other members.</div>
            </div>
...
<div class="csc-support-box">
    ...
    <div>
        <div class="csc-support-box__title">Need Additional Support?</div>
        <div class="csc-support-box__text">For additional support, please contact Holly McGeown at <a
                href="mailto:holly.mcgeown@wamagency.co.uk">holly.mcgeown@wamagency.co.uk</a>.</div>
    </div>
</div>
<?php
		return ob_get_clean();
